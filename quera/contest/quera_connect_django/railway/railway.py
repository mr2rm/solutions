...
class Trip:
    all_cities = (
        ...
        'Tabriz', 'Tehran', 'Khorramabad', 'Rasht', 'Zahedan', 'Zanjan', 'Sari', 'Semnan', 'Sanandaj', 'Shahr-e Kord',
        'Shiraz', 'Qazvin', 'Qom', 'Karaj', 'Kermanshah', 'Gorgan', 'Mashhad', 'Hamadan', 'Yasuj', 'Yazd'
    )
    ...
    def __call__(self, *args, **kwargs):
        loads_weight = sum(map(lambda p: p.load_weight, self.passengers))
        return self.train.weight_capacity - loads_weight
